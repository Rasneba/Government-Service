...
const menuItems = [
  ...
  { href: '/citizen/dashboard', label: 'Citizen Portal', icon: UserCheck, roles: ['SystemAdministrator', 'SubCityAdministrator'] },
  ...
  return (
    ...
    >
      <div className="p-4 border-b border-gray-700 flex items-center justify-between">
        {!collapsed && (
          <div>
            <h1 className="font-bold text-lg">Letter System</h1>
