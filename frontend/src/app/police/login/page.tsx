      ...
      <div className="w-full max-w-md px-4">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-slate-800">{t('auth.policeLoginTitle')}</h1>
            <p className="text-slate-500 text-sm mt-1">{t('auth.policeLoginSubtitle')}</p>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 text-center">
            <a href="/" className="text-sm text-slate-500 hover:text-slate-700">{t('common.back')}</a>
          </div>
