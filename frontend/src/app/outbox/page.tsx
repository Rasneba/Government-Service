...
export default function OutboxPage() {
  ...
  const columns = [
    ...
    { key: 'receiver', header: t('letters.recipient'), render: (item: LetterListItem) => item.receiverName || 'N/A' },
  ...
  return (
    <Layout>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">{t('nav.outbox')}</h1>
